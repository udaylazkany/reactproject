...
SetEmailError(err.response.status)}
    ...
    return(   <div className="sing_up_style">
...
<div className="inputBox" ><input id="Name"  type="text" required  value={Name} onChange={e=>SetName(e.target.value)}/>
...
{Accept&&EmailError===422&&<p className="Error"> Email alreade has been</p>}
...
<div className="inputBox"><input id="Repassword" type="Password" required value={Repassword} onChange={e=>SetRepassword(e.target.value)} />
<span htmlFor="Repassword">Repassword</span>
<i></i>
</div>
{Repassword!==password&&Accept&&<p className="Error">password dosn't muchs</p>}
<button type="submit" className="button1" >{props.button}</button>
</form>
